...
public interface AppService {
	...
	public void generateFilesFromTemplateV2(Map<String, List<ApiJsonTemplate>> map,String src,String dest,API apiDto);
	public void compileProject(String fileLocation);
	public Map<String, List<ApiJsonTemplate>> prepareMapForTemplateV2(API api);
}
